...
SINGLE_SET_CASES = [
    ("Temp 1 (single)", {"n": 20.1, "w": 20.0, "s": 20.4, "e": 18.8}),
    ("Phi 1 (single)", {"n": 51.0, "w": 50.0, "s": 51.0, "e": 50.0}),
    ("Temp 2 (single)", {"n": 25.2, "w": 24.2, "s": 25.4, "e": 24.5}),
    ("Phi 2 (single)", {"n": 54.0, "w": 52.0, "s": 53.0, "e": 47.0}),
    ("Temp 3 (single)", {"n": 23.3, "w": 23.3, "s": 24.0, "e": 22.5}),
    ("Phi 3 (single)", {"n": 39.0, "w": 39.0, "s": 35.0, "e": 41.0}),
    ("Temp 4 (single)", {"n": 22.4, "w": 22.0, "s": 22.4, "e": 22.2}),
    ("Phi 4 (single)", {"n": 42.0, "w": 41.0, "s": 41.0, "e": 41.0}),
]
